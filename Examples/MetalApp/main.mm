...
//	{
		...
		while (!window->shouldClose())
		{
			...
			//			camChanged |= ImGui::DragFloat("Focal dist", &camera.focalDistance, 0.0001f, 0.00001f, 1e10f,
			//"%.7f"); 			ImGui::End();
			...
			//			matChanged |= ImGui::DragFloat("ClearCoatGloss", &hostMaterial.clearcoatGloss, 0.01f,
			//0.0f, 1.0f); 			matChanged |= ImGui::DragFloat("Sheen", &hostMaterial.sheen, 0.01f, 0.0f, 1.0f); 			matChanged
			//|= ImGui::DragFloat("Sheen tint", &hostMaterial.sheenTint, 0.01f, 0.0f, 1.0f); 			matChanged |=
			//ImGui::DragFloat("Specular", &hostMaterial.specular, 0.01f, 0.0f, 1.0f); 			matChanged |=
			//ImGui::DragFloat("Spec tint", &hostMaterial.specularTint, 0.01f, 0.0f, 1.0f); 			matChanged |=
			//ImGui::DragFloat("Subsurface", &hostMaterial.subsurface, 0.01f, 0.0f, 1.0f); 			ImGui::End();
