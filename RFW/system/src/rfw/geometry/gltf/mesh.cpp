...
SceneMesh::SceneMesh() { flags |= INITIAL_PRIM; }
SceneMesh::SceneMesh(const SceneObject &obj) : object(const_cast<SceneObject *>(&obj)) { flags |= Flags::INITIAL_PRIM; }

void SceneMesh::set_pose(const MeshSkin &skin)
{
	using namespace glm;
...
void SceneMesh::set_pose(const std::vector<float> &wghts)
{
...
void SceneMesh::set_transform(const glm::mat4 &transform)
{
...
vec4 *gltf::SceneMesh::get_vertices() { return &object->vertices[vertexOffset]; }
const vec4 *gltf::SceneMesh::get_vertices() const { return &object->vertices[vertexOffset]; }

rfw::simd::vector4 *gltf::SceneMesh::getBaseVertices() { return &object->baseVertices[vertexOffset]; }
const rfw::simd::vector4 *gltf::SceneMesh::getBaseVertices() const { return &object->baseVertices[vertexOffset]; }

rfw::Triangle *gltf::SceneMesh::get_triangles() { return &object->triangles[triangleOffset]; }

const rfw::Triangle *gltf::SceneMesh::get_triangles() const { return &object->triangles[triangleOffset]; }

glm::uvec3 *gltf::SceneMesh::getIndices()
{
	if (flags & HAS_INDICES)
...
const glm::uvec3 *gltf::SceneMesh::getIndices() const
{
	if (flags & HAS_INDICES)
		return &object->indices[faceOffset];
	return nullptr;
...
glm::vec2 *gltf::SceneMesh::getTexCoords() { return &object->texCoords[vertexOffset]; }

const glm::vec2 *gltf::SceneMesh::getTexCoords() const { return &object->texCoords[vertexOffset]; }

glm::vec3 *gltf::SceneMesh::getNormals() { return &object->normals[vertexOffset]; }
const glm::vec3 *gltf::SceneMesh::getNormals() const { return &object->normals[vertexOffset]; }

rfw::simd::vector4 *gltf::SceneMesh::getBaseNormals() { return &object->baseNormals[vertexOffset]; }
const rfw::simd::vector4 *gltf::SceneMesh::getBaseNormals() const { return &object->baseNormals[vertexOffset]; }

void SceneMesh::add_primitive(const std::vector<int> &indces, const std::vector<glm::vec3> &verts,
							  const std::vector<glm::vec3> &nrmls, const std::vector<glm::vec2> &uvs,
							  const std::vector<gltf::SceneMesh::Pose> &pses, const std::vector<glm::uvec4> &jnts,
...
void SceneMesh::update_triangles() const
{
