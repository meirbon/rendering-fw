...
rfw::Quad::Quad(const glm::vec3 &N, const glm::vec3 &pos, float width, float height, const uint material)
	: m_MatID(material)
{
...
uint rfw::Quad::getMaterialForPrim(uint primitiveIdx) const
{
	return m_MatID;
}
