...
class RandomGenerator
{
  public:
	...
	inline void createCoordinateSystem(const glm::vec3 &N, glm::vec3 &Nt, glm::vec3 &Nb)
	{
		...
		{
			Nt = glm::vec3(N.z, 0.f, -N.x) / sqrt(N.x * N.x + N.z * N.z);
		}
		else
		{
			Nt = glm::vec3(0.f, -N.z, N.y) / sqrt(N.y * N.y + N.z * N.z);
		}

		Nb = cross(N, Nt);
	}

	inline glm::vec3 localToWorld(const glm::vec3 &sample, const glm::vec3 &Nt, const glm::vec3 &Nb, const glm::vec3 &normal)
	{
		return glm::vec3(sample.x * Nb.x + sample.y * normal.x + sample.z * Nt.x, sample.x * Nb.y + sample.y * normal.y + sample.z * Nt.y,
						 sample.x * Nb.z + sample.y * normal.z + sample.z * Nt.z);
	}

	inline glm::vec3 worldToLocalMicro(const glm::vec3 &vec, const glm::vec3 &rDirection, glm::vec3 &u, glm::vec3 &v, glm::vec3 &w)
	{
		w = vec;
	...
	inline glm::vec3 localToWorldMicro(const glm::vec3 &wmLocal, const glm::vec3 &u, const glm::vec3 &v, const glm::vec3 &w)
	{
