...
__host__ __device__ static inline glm::vec3 tangentToWorld(const glm::vec3 &sample, const glm::vec3 &N, const glm::vec3 &T,
											 const glm::vec3 &B)
{
	return glm::vec3(dot(T, sample), dot(B, sample), dot(N, sample));
}

__host__ __device__ static inline glm::vec3 worldToTangent(const glm::vec3 &sample, const glm::vec3 &N, const glm::vec3 &T,
											 const glm::vec3 &B)
{
